  ...
  return (
    <>
      <p className="tab-desc">
        Universal Links (iOS) and App Links (Android) skip the custom-scheme prompt entirely — a real
        https:// link opens the app directly if it's installed, or the web page if not.
      </p>
...
<intent-filter android:autoVerify="true">
  <data android:scheme="https" android:host="geet.app"/>
      ...
      <div className="demo-note">// No installed app → same URL opens the mobile web fallback instead.</div>
    </>
  );
}
