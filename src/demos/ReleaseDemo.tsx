...
export default function ReleaseDemo() {
  ...
  return (
    <>
      <p className="tab-desc">Co-architected RN's packaging as a versioned native binary (XCFramework + AAR) — decoupling the RN layer from native host apps, no Node/Yarn toolchain required for native teams.</p>
...
implementation 'com.company:rn-module:4.12.0' // AAR`}</pre>
      ...
      <div className="demo-note">// Native teams bump one version string — no RN toolchain install, no Metro, no Yarn.</div>
    </>
  );
}
