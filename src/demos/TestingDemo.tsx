...
export default function TestingDemo() {
  ...
  return (
    <>
      <p className="tab-desc">1,500+ commits across 200+ tickets at PlanRadar, guarded by a 3,500+ test suite in GitLab CI/CD. Run a sample suite.</p>
  ...
  it('uses O(1) Set lookup, not array scan', () => {
    ...
    expect(result.current.selected.has('row-1')).toBe(true);
      ...
      <div className="demo-note">// CI blocks merge on red tests — coverage gate keeps refactors safe across 200+ tickets.</div>
    </>
  );
}
